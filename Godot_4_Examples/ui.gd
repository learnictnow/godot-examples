...
func _on_button_3_rd_person_pressed():
	print("3rd")
	get_tree().change_scene_to_file("res://player_3rd/Level_3rd_person.tscn")
	pass # Replace with function body.
...
func _on_button_space_flight_pressed():
	print("Space")
	get_tree().change_scene_to_file("res://player_space/Level_space.tscn")
	pass # Replace with function body.


func _on_button_car_pressed():
	print("Car")
	get_tree().change_scene_to_file("res://player_vehicle/Level_vehicle.tscn")
	pass # Replace with function body.


func _on_button_point_and_click_pressed():
	print("RTS and Navmesh movement")
	get_tree().change_scene_to_file("res://player_point_and_click_movement/Level_Town.tscn")
	pass # Replace with function body.
